...
```
/Layout.test.tsx > Layout > sidebar state > should_openSidebar_whenHamburgerIsClicked 79ms
 ✓ src/components/Layout/Layout.test.tsx > Layout > sidebar state > should_showOverlay_whenSidebarIsOpen 67ms
 ...
 ✓ src/components/AppHeader/AppHeader.test.tsx > AppHeader > auth button — logged in > should_navigateToLogoutUrl_whenLogoutClicked 32ms
 ✓ src/components/AppHeader/AppHeader.test.tsx > AppHeader > desktop — welcome message > should_showWelcomeMessage_whenUserIsLoggedIn 23ms
 ...
 ✓ src/components/AppHeader/AppHeader.test.tsx > AppHeader > desktop — menubar > should_renderMenubarComponent 20ms
 ...
 ✓ src/components/Layout/Layout.test.tsx > Layout > sidebar state > should_closeSidebar_whenOverlayIsClicked 71ms
 ✓ src/components/Layout/Layout.test.tsx > Layout > sidebar state > should_closeSidebar_whenXButtonIsClicked 69ms
 ✓ src/components/Layout/Layout.test.tsx > Layout > sidebar state > should_notShowOverlay_whenSidebarIsClosed 27ms
 ✓ src/components/Layout/Layout.test.tsx > Layout > body scroll lock > should_lockBodyScroll_whenSidebarOpens 44ms
 ✓ src/components/Layout/Layout.test.tsx > Layout > body scroll lock > should_restoreBodyScroll_whenSidebarCloses 60ms

 Test Files  8 passed (8)
      Tests  70 passed (70)
   Start at  14:49:23
   Duration  2.86s (transform 648ms, setup 2.15s, import 1.62s, tests 3.11s, environment 7.70s)
